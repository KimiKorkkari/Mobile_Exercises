import React, { useState, useEffect } from 'react';
 ...
 const MovieListScreen: () => Node = ({navigation}) => {
  ...
  function MoviesList(props) {
    ...
    let movieItems = movies.map(function(movie,index){ //Tässä käydään talukko läpi, ja kutsutaan MovieListItemiä, joka lisää kuvan ja tiedot jokaiselle listattavalle elokuvalle..
      return (
